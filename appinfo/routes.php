...
$app->registerRoutes($this, array('routes' => array(
	...
	// settings
	array('name' => 'setting#userPath', 'url' => '/settings/user/path', 'verb' => 'POST', 'postfix'=>'deprecated'),
	array('name' => 'setting#userPath', 'url' => '/api/settings/user/path', 'verb' => 'POST'),
	array('name' => 'setting#getAll', 'url' => '/api/settings', 'verb' => 'GET'),
	array('name' => 'setting#addUserKey', 'url' => '/settings/userkey/add', 'verb' => 'POST', 'postfix'=>'deprecated'),
	array('name' => 'setting#addUserKey', 'url' => '/api/settings/userkey/add', 'verb' => 'POST'),
	array('name' => 'setting#generateUserKey', 'url' => '/settings/userkey/generate', 'verb' => 'POST', 'postfix'=>'deprecated'),
	array('name' => 'setting#generateUserKey', 'url' => '/api/settings/userkey/generate', 'verb' => 'POST'),
	array('name' => 'setting#removeUserKey', 'url' => '/settings/userkey/remove', 'verb' => 'POST', 'postfix'=>'deprecated'),
