...
/* jshint -W100 */
    ...
    gettextCatalog.setStrings('ar', {"Albums":"الألبومات","Artists":"الفنانون","Description":"وصف","Music":"الموسيقى","Next":"التالي","Pause":"إيقاف","Play":"تشغيل","Previous":"السابق","Repeat":"إعادة","Shuffle":"اختيار عشوائي","Tracks":"المقاطع","Unknown album":"ألبوم غير معروف","Unknown artist":"فنان غير معروف"});
    ...
    gettextCatalog.setStrings('id', {"Description":"Penjelasan","Music":"Musik","Next":"Selanjutnya","Pause":"Jeda","Play":"Putar","Previous":"Sebelumnya","Repeat":"Ulangi","Shuffle":"Acak"});
    ...
    gettextCatalog.setStrings('uk', {"Description":"Опис","Music":"Музика","Next":"Наступний","Pause":"Пауза","Play":"Грати","Previous":"Попередній","Repeat":"Повторювати","Shuffle":"Перемішати"});
    ...
    gettextCatalog.setStrings('zh_TW', {"Albums":"專輯","Artists":"歌手","Description":"描述","Description (e.g. App name)":"描述 (例: App 名稱)","Generate API password":"產生 API 密碼","Invalid path":"無效的路徑","Music":"音樂","Next":"下一個","Pause":"暫停","Play":"播放","Previous":"上一個","Repeat":"重覆","Revoke API password":"撤銷 API 密碼","Shuffle":"隨機播放","Some not playable tracks were skipped.":"部份無法播放的曲目已跳過。","Tracks":"曲目","Unknown album":"未知的專輯","Unknown artist":"未知的歌手"});
/* jshint +W100 */
}]);
