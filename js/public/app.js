...
/* jshint -W100 */
    ...
    gettextCatalog.setStrings('ar', {"Albums":"الألبومات","Artists":"الفنانون","Description":"وصف","Loading ...":"تحميل ...","Music":"الموسيقى","Next":"التالي","Pause":"إيقاف","Play":"تشغيل","Previous":"السابق","Repeat":"إعادة","Shuffle":"اختيار عشوائي","Tracks":"المقاطع","Unknown album":"ألبوم غير معروف","Unknown artist":"فنان غير معروف"});
    ...
    gettextCatalog.setStrings('bn_BD', {"Description":"বিবরণ","Music":"গানবাজনা","Next":"পরবর্তী","Pause":"বিরতি","Play":"বাজাও","Previous":"পূর্ববর্তী","Repeat":"পূনঃসংঘটন"});
    ...
    gettextCatalog.setStrings('de_AT', {"Description":"Beschreibung","Loading ...":"Lade ...","Music":"Musik","Next":"Nächstes","Pause":"Pause","Play":"Abspielen","Previous":"Vorheriges","Repeat":"Wiederholen","Shuffle":"Zufallswiedergabe","Unknown album":"Unbekanntes Album","Unknown artist":"Unbekannter Künstler"});
    ...
    gettextCatalog.setStrings('es_MX', {"Description":"Descripción","Loading ...":"Cargando ...","Music":"Música","Next":"Siguiente","Pause":"Pausa","Play":"Reproducir","Previous":"Anterior","Repeat":"Repetir","Shuffle":"Mezclar"});
    ...
    gettextCatalog.setStrings('fa', {"Albums":"آلبوم ها","Artists":"هنرمندان","Description":"توضیحات","Invalid path":"مسیر اشتباه","Loading ...":"درحال بارگذاری...","Music":"موزیک","Next":"بعدی","Pause":"توقف کردن","Play":"پخش کردن","Previous":"قبلی","Repeat":"تکرار","Shuffle":"درهم"});
    ...
    gettextCatalog.setStrings('id', {"Description":"Penjelasan","Loading ...":"Memuat ...","Music":"Musik","Next":"Selanjutnya","Pause":"Jeda","Play":"Putar","Previous":"Sebelumnya","Repeat":"Ulangi","Shuffle":"Acak"});
    ...
    gettextCatalog.setStrings('ko', {"Albums":"앨범","Artists":"음악가","Description":"종류","Generate API password":"API 비밀번호 생성","Loading ...":"불러오는 중...","Music":"음악","Next":"다음","Pause":"일시 정지","Play":"재생","Previous":"이전","Repeat":"반복","Shuffle":"임의 재생","Unknown album":"알려지지 않은 앨범","Unknown artist":"알려지지 않은 아티스트"});
    ...
    gettextCatalog.setStrings('lt_LT', {"Description":"Aprašymas","Loading ...":"Įkeliama ...","Music":"Muzika","Next":"Kitas","Pause":"Pristabdyti","Play":"Groti","Previous":"Ankstesnis","Repeat":"Kartoti","Shuffle":"Maišyti","Unknown album":"Nežinomas albumas","Unknown artist":"Nežinomas atlikėjas"});
    ...
    gettextCatalog.setStrings('ms_MY', {"Description":"Keterangan","Loading ...":"Memuatkan ...","Music":"Muzik","Next":"Seterus","Pause":"Jeda","Play":"Main","Previous":"Sebelum","Repeat":"Ulang","Shuffle":"Kocok"});
    ...
    gettextCatalog.setStrings('sq', {"Description":"Përshkrimi","Loading ...":"Ngarkim...","Music":"Muzikë","Next":"Mëpasshëm","Pause":"Pauzë","Play":"Luaj","Previous":"Mëparshëm","Repeat":"Përsëritet","Shuffle":"Përziej"});
    gettextCatalog.setStrings('sr', {"Description":"Опис","Music":"Музика","Next":"Следећа","Pause":"Паузирај","Play":"Пусти","Previous":"Претходна","Repeat":"Понављај"});
    gettextCatalog.setStrings('sr@latin', {"Description":"Opis","Music":"Muzika","Next":"Sledeća","Pause":"Pauziraj","Play":"Pusti","Previous":"Prethodna","Repeat":"Ponavljaj"});
    ...
    gettextCatalog.setStrings('uk', {"Description":"Опис","Loading ...":"Завантаження ...","Music":"Музика","Next":"Наступний","Pause":"Пауза","Play":"Грати","Previous":"Попередній","Repeat":"Повторювати","Shuffle":"Перемішати"});
    ...
    gettextCatalog.setStrings('vi', {"Description":"Mô tả","Loading ...":"Đang tải ...","Music":"Âm nhạc","Next":"Kế tiếp","Pause":"Tạm dừng","Play":"Play","Previous":"Lùi lại","Repeat":"Lặp lại","Shuffle":"Ngẫu nhiên","Unknown album":"Không tìm thấy album","Unknown artist":"Không tìm thấy nghệ sĩ"});
    ...
    gettextCatalog.setStrings('zh_HK', {"Music":"音樂","Next":"下一首","Pause":"暫停","Play":"播放","Previous":"上一首"});
