...
/* jshint -W100 */
    ...
    gettextCatalog.setStrings('ar', {"Albums":"الألبومات","Artists":"الفنانون","Chrome is only able to play MP3 files - see <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>":"متصفح كروم يمكنه تشغيل ملفات MP3 فقط - الرجاء الاطلاع على  <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">الويكي</a>","Delete":"حذف","Loading ...":"تحميل ...","Music":"الموسيقى","Next":"التالي","Nothing in here. Upload your music!":"لا شيء موجود هنا. إرفع بعض الموسيقى !","Pause":"إيقاف","Play":"تشغيل","Previous":"السابق","Repeat":"إعادة","Show all {{ trackcount }} songs ...":[".","إظهار المقطع","إظهار المقطعين","إظهار كافة المقاطع الـ {{ trackcount }}","إظهار كافة المقاطع الـ {{ trackcount }}","إظهار كافة المقاطع الـ {{ trackcount }}"],"Show less ...":"إظهار أقل ...","Shuffle":"اختيار عشوائي","Tracks":"المقاطع","Unknown album":"ألبوم غير معروف","Unknown artist":"فنان غير معروف"});
    ...
    gettextCatalog.setStrings('da', {"Albums":"Album","Artists":"Kunstnere","Chrome is only able to play MP3 files - see <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>":"Chromekan kun afspille MP3 filer - se <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>","Delete":"Slet","Loading ...":"Indlæser...","Music":"Musik","Next":"Næste","Nothing in here. Upload your music!":"Her er tomt. Upload din musik!","Pause":"Pause","Play":"Afspil","Previous":"Forrige","Repeat":"Gentag","Show all {{ trackcount }} songs ...":["Vis alle {{ trackcount }} sange ...","Vis alle {{ trackcount }} sange ..."],"Show less ...":"Vis færre ...","Shuffle":"Bland","Tracks":"Spor","Unknown album":"Ukendt album","Unknown artist":"Ukendt artist"});
    gettextCatalog.setStrings('de', {"Albums":"Alben","Artists":"Künstler","Chrome is only able to play MP3 files - see <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>":"Chrome ist nur in der Lage, MP3-Dateien wiederzugeben - siehe in das <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">Wiki</a>","Delete":"Löschen","Invalid path":"Ungültiger Pfad","Loading ...":"Lade ...","Music":"Musik","Next":"Weiter","Nothing in here. Upload your music!":"Alles leer. Lade Deine Musik hoch!","Path to your music collection":"Pfad zu Deiner Musiksammlung","Pause":"Anhalten","Play":"Abspielen","Previous":"Zurück","Repeat":"Wiederholen","Show all {{ trackcount }} songs ...":["{{ trackcount }} Lied anzeigen  ...","Alle {{ trackcount }} Lieder anzeigen  ..."],"Show less ...":"Weniger anzeigen ...","Shuffle":"Zufallswiedergabe","This setting restricts the shown music in the web interface of the music app.":"Diese Einstellung beschränkt die angezeigte Musik im Webinterface der Musik-Applikation","Tracks":"Titel","Unknown album":"Unbekanntes Album","Unknown artist":"Unbekannter Künstler"});
    ...
    gettextCatalog.setStrings('de_DE', {"Albums":"Alben","Artists":"Künstler","Chrome is only able to play MP3 files - see <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>":"Chrome ist nur in der Lage, MP3-Dateien wiederzugeben - siehe in das <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">Wiki</a>","Delete":"Löschen","Invalid path":"Ungültiger Pfad","Loading ...":"Lade …","Music":"Musik","Next":"Weiter","Nothing in here. Upload your music!":"Alles leer. Laden Sie Ihre Musik hoch!","Path to your music collection":"Pfad zu Ihrer Musiksammlung","Pause":"Anhalten","Play":"Abspielen","Previous":"Zurück","Repeat":"Wiederholen","Show all {{ trackcount }} songs ...":["{{ trackcount }} Lied anzeigen  ...","Alle {{ trackcount }} Lieder anzeigen  ..."],"Show less ...":"Weniger anzeigen ...","Shuffle":"Zufallswiedergabe","This setting restricts the shown music in the web interface of the music app.":"Diese Einstellung beschränkt die angezeigte Musik im Webinterface der Musik-Applikation","Tracks":"Titel","Unknown album":"Unbekanntes Album","Unknown artist":"Unbekannter Künstler"});
    ...
    gettextCatalog.setStrings('en_GB', {"Albums":"Albums","Artists":"Artists","Chrome is only able to play MP3 files - see <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>":"Chrome is only able to play MP3 files - see <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>","Delete":"Delete","Invalid path":"Invalid path","Loading ...":"Loading...","Music":"Music","Next":"Next","Nothing in here. Upload your music!":"Nothing in here. Upload your music!","Path to your music collection":"Path to your music collection","Pause":"Pause","Play":"Play","Previous":"Previous","Repeat":"Repeat","Show all {{ trackcount }} songs ...":["Show all {{ trackcount }} songs...","Show all {{ trackcount }} songs..."],"Show less ...":"Show less...","Shuffle":"Shuffle","This setting restricts the shown music in the web interface of the music app.":"This setting restricts the music shown in the web interface of the music app.","Tracks":"Tracks","Unknown album":"Unknown album","Unknown artist":"Unknown artist"});
    ...
    gettextCatalog.setStrings('it', {"Albums":"Album","Artists":"Artisti","Chrome is only able to play MP3 files - see <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>":"Chrome è in grado di riprodurre solo file MP3 - vedi il <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>","Delete":"Elimina","Invalid path":"Percorso non valido","Loading ...":"Caricamento in corso...","Music":"Musica","Next":"Successivo","Nothing in here. Upload your music!":"Non c'è niente qui. Carica la tua musica!","Path to your music collection":"Percorso alla tua collezione musicale","Pause":"Pausa","Play":"Riproduci","Previous":"Precedente","Repeat":"Ripeti","Show all {{ trackcount }} songs ...":["Mostra {{ trackcount }} brano...","Mostra tutti i {{ trackcount }} brani..."],"Show less ...":"Mostra meno...","Shuffle":"Mescola","This setting restricts the shown music in the web interface of the music app.":"Questa impostazione filtra la musica mostrata nell'interfaccia web dell'applicazione musicale.","Tracks":"Tracce","Unknown album":"Album sconosciuto","Unknown artist":"Artista sconosciuto"});
    ...
    gettextCatalog.setStrings('nl', {"Albums":"Albums","Artists":"Artiesten","Chrome is only able to play MP3 files - see <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>":"Chrome kan alleen MP3 bestanden - zie <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>","Delete":"Verwijder","Invalid path":"Ongeldig pad","Loading ...":"Laden ...","Music":"Muziek","Next":"Volgende","Nothing in here. Upload your music!":"Nog niets aanwezig. Upload uw muziek!","Path to your music collection":"Pad naar uw muziekverzameling","Pause":"Pause","Play":"Afspelen","Previous":"Vorige","Repeat":"Herhaling","Show all {{ trackcount }} songs ...":["Toon elk {{ trackcount }} nummer ...","Toon alle {{ trackcount }} nummers ..."],"Show less ...":"Toon minder ...","Shuffle":"Shuffle","This setting restricts the shown music in the web interface of the music app.":"Deze instelling beperkt de in de webinterface van de muziek app te tonen muziek.","Tracks":"Nummers","Unknown album":"Onbekend album","Unknown artist":"Onbekende artiest"});
