...
/* jshint -W100 */
    ...
    gettextCatalog.setStrings('bg_BG', {"Delete":"Изтриване","Description":"Описание","Loading ...":"Зареждане ...","Music":"Музика","Next":"Следваща","Pause":"Пауза","Play":"Пусни","Previous":"Предишна","Repeat":"Повтори","Shuffle":"Разбъркване","Unknown album":"Непознат албум","Unknown artist":"Непознат изпълнител"});
    ...
    gettextCatalog.setStrings('da', {"Albums":"Album","Artists":"Kunstnere","Delete":"Slet","Description":"Beskrivelse","Loading ...":"Indlæser...","Music":"Musik","Next":"Næste","Pause":"Pause","Play":"Afspil","Previous":"Forrige","Repeat":"Gentag","Shuffle":"Bland","Tracks":"Spor","Unknown album":"Ukendt album","Unknown artist":"Ukendt artist"});
    ...
    gettextCatalog.setStrings('ja_JP', {"Albums":"アルバム","Artists":"アーティスト","Delete":"削除","Description":"説明","Description (e.g. App name)":"説明 (例えばアプリケーション名)","Generate API password":"APIパスワードの生成","Invalid path":"パスが無効","Loading ...":"読込中 ...","Music":"ミュージック","Next":"次","Path to your music collection":"音楽コレクションのパス","Pause":"一時停止","Play":"再生","Previous":"前","Repeat":"繰り返し","Shuffle":"シャッフル","Some not playable tracks were skipped.":"いくつかの再生不可能なトラックを飛ばしました。","This setting specifies the folder which will be scanned for music.":"この設定では、音楽ファイルをスキャンするフォルダを指定します。","Tracks":"トラック","Unknown album":"不明なアルバム","Unknown artist":"不明なアーティスト"});
    ...
    gettextCatalog.setStrings('ko', {"Delete":"삭제","Description":"종류","Loading ...":"불러오는 중...","Music":"음악","Next":"다음","Pause":"일시 정지","Play":"재생","Previous":"이전","Repeat":"반복","Shuffle":"임의 재생","Unknown album":"알려지지 않은 앨범","Unknown artist":"알려지지 않은 아티스트"});
    ...
    gettextCatalog.setStrings('mk', {"Delete":"Избриши","Description":"Опис","Loading ...":"Вчитувам ...","Music":"Музика","Next":"Следно","Pause":"Пауза","Play":"Пушти","Previous":"Претходно","Repeat":"Повтори","Shuffle":"Помешај"});
    ...
    gettextCatalog.setStrings('zh_TW', {"Delete":"刪除","Description":"描述","Loading ...":"載入中…","Music":"音樂","Next":"下一個","Pause":"暫停","Play":"播放","Previous":"上一個","Repeat":"重覆","Shuffle":"隨機播放"});
/* jshint +W100 */
}]);
