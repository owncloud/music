...
/* jshint -W100 */
    ...
    gettextCatalog.setStrings('el', {"Delete":"Διαγραφή","Loading ...":"Φόρτωση ...","Music":"Μουσική","Next":"Επόμενο","Nothing in here. Upload your music!":"Δεν υπάρχει τίποτα εδώ. Μεταφορτώστε την μουσική σας!","Pause":"Παύση","Play":"Αναπαραγωγή","Previous":"Προηγούμενο","Repeat":"Επανάληψη","Show all {{ trackcount }} songs ...":["Εμφάνιση του τραγουδιού","Εμφάνιση όλων των {{ trackcount }} τραγουδιών ..."],"Show less ...":"Προβολή λιγότερων...","Shuffle":"Τυχαία αναπαραγωγή","Unknown album":"Άγνωστο άλμπουμ","Unknown artist":"Άγνωστος καλλιτέχνης"});
