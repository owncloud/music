...
/* jshint -W100 */
    ...
    gettextCatalog.setStrings('ru', {"Albums":"Альбомы","Artists":"Исполнители","Delete":"Удалить","Description":"Описание","Generate API password":"Генерация пароля для API","Invalid path":"Некорректный путь","Loading ...":"Загружается...","Music":"Музыка","Next":"Следующий","Nothing in here. Upload your music!":"Здесь ничего нет. Загрузите вашу музыку!","Path to your music collection":"Путь до вашей музыкальной коллекции","Pause":"Пауза","Play":"Проиграть","Previous":"Предыдущий","Repeat":"Повтор","Revoke API password":"Отозвать пароль для API","Scanning ...":"Поиск ...","Show all {{ trackcount }} songs ...":["Показать {{ trackcount }} песню...","Показать все {{ trackcount }} песни...","Показать все {{ trackcount }} песен..."],"Show less ...":"Показать меньше...","Shuffle":"Перемешать","Tracks":"Композиции","Unknown album":"Неизвестный альбом","Unknown artist":"Неизвестный исполнитель"});
    ...
    gettextCatalog.setStrings('zh_CN', {"Albums":"专辑页","Artists":"艺术家","Delete":"删除","Description":"描述","Description (e.g. App name)":"描述 (例如 App 名称)","Generate API password":"生成 API 密码","Invalid path":"无效路径","Loading ...":"加载中...","Music":"音乐","Next":"下一个","Nothing in here. Upload your music!":"这里还什么都没有。上传你的音乐吧！","Pause":"暂停","Play":"播放","Previous":"前一首","Repeat":"重复","Scanning ...":"扫描中 ...","Show all {{ trackcount }} songs ...":"显示所有 {{ trackcount }} 首歌曲 ...","Show less ...":"显示概要","Shuffle":"随机","Tracks":"音轨","Unknown album":"未知专辑","Unknown artist":"未知艺术家"});
