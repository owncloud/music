...
angular.module("Music").run(['gettextCatalog', function (gettextCatalog) {
    ...
    gettextCatalog.setStrings('ms_MY', {"Music":"Muzik","Loading ...":"Memuatkan ...","Previous":"Sebelum","Play":"Main","Pause":"Jeda","Next":"Seterus","Shuffle":"Kocok","Repeat":"Ulang","Delete":"Padam","Nothing in here. Upload your music!":"Tiada apa-apa di sini. Muat naik muzik anda!","Show all {{ trackcount }} songs ...":"Paparkan semua {{ trackcount }} lagu ...","Show less ...":"Kurangkan paparan ...","Chrome is only able to playback MP3 files - see <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>":"Chrome hanya boleh memainkan fail MP3 - lihat <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>"});
    ...
    gettextCatalog.setStrings('sl', {"Music":"Glasba","Loading ...":"Nalaganje ...","Previous":"Predhodna","Play":"Predvajaj","Pause":"Premor","Next":"Naslednja","Shuffle":"Premešaj","Repeat":"Ponovi","Delete":"Izbriši","Nothing in here. Upload your music!":"V mapi ni glasbenih datotek. Dodajte skladbe!","Show all {{ trackcount }} songs ...":["Pokaži {{ trackcount }} posnetek ...","Pokaži {{ trackcount }} posnetka ...","Pokaži {{ trackcount }} posnetke ...","Pokaži {{ trackcount }} posnetkov ..."],"Show less ...":"Pokaži manj ...","Chrome is only able to playback MP3 files - see <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>":"Brskalnik Chrome lahko predvaja le datoteke MP3 - več podrobnosti je na straneh <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>."});
    ...
    gettextCatalog.setStrings('uz', {"Music":"","Loading ...":"","Previous":"","Play":"","Pause":"","Next":"","Shuffle":"","Repeat":"","Delete":"","Nothing in here. Upload your music!":"","Show all {{ trackcount }} songs ...":"","Show less ...":"","Chrome is only able to playback MP3 files - see <a href=\"https://github.com/owncloud/music/wiki/Frequently-Asked-Questions#why-can-chromechromium-just-playback-mp3-files\">wiki</a>":""});
