...
"Artists" => "Flytjandi",
"Description" => "Lýsing",
"Description (e.g. App name)" => "Lýsing (t.d. heiti á forriti)",
"Generate API password" => "Framleiða API-lykilorð",
"Here you can generate passwords to use with the Ampache API, because they can't be stored in a really secure way due to the design of the Ampache API. You can generate as many passwords as you want and revoke them anytime." => "Hér geturðu útbúið lykilorð til að nota með Ampache API, því ekki er hægt að geyma þau á algerlega öruggan máta vegna uppbyggingar Ampache API-samskiptareglnanna. Þú getur búið til eins mörg lykilorð og þér sýnist, og afturkallað þau hvenær sem er.",
"Invalid path" => "Ógild slóð",
"Keep in mind, that the Ampache API is just a preview and is unstable. Feel free to report your experience with this feature in the corresponding <a href=\"https://github.com/owncloud/music/issues/60\">issue</a>. I would also like to have a list of clients to test with. Thanks" => "Hafðu í huga að Ampache API er bara sýnishorn og að það er óstöðugt. Þú mátt alveg segja frá reynslu þinni af notkun þess á tilheyrandi <a href=\"https://github.com/owncloud/music/issues/60\">færslu</a>. Það væri einnig gott að fá með lista yfir þau forrit sem hafa verið prófuð. Takk fyrir",
"Music" => "Tónlist",
"Next" => "Næst",
"Path to your music collection" => "Slóð á tónlistarsafnið þitt",
"Pause" => "Í bið",
"Play" => "Spila",
"Previous" => "Fyrra",
"Repeat" => "Endurtaka",
"Revoke API password" => "Afturkalla API-lykilorð",
"Shuffle" => "Stokka",
