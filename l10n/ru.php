...
"Keep in mind, that the Ampache API is just a preview and is unstable. Feel free to report your experience with this feature in the corresponding <a href=\"https://github.com/owncloud/music/issues/60\">issue</a>. I would also like to have a list of clients to test with. Thanks" => "Следует помнить, что API Ampache является демо-версией и поэтому неустойчиво. Мы будем признательны, если вы поделитесь опытом работы с этой функцией в соответствующем <a href=\"https://github.com/owncloud/music/issues/60\">разделе</a>. Я также хотел бы создать список клиентов для тестирования. Спасибо",
"Music" => "Музыка",
"Next" => "Следующий",
...
"Shuffle" => "Перемешать",
"Some not playable tracks were skipped." => "Некоторые непроигрываемые композиции были пропущены.",
...
"Use your username and following password to connect to this Ampache instance:" => "Используйте свой логин и следующий ниже пароль для подключения к данному экземпляру Ampache:"
);
