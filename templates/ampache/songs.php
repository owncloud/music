...
<?php foreach ($_['songs'] as $song): ?>
	<song id='<?php p($song->getId());?>'>
		...
		<artist id='<?php p($song->getArtist()->getId());?>'><?php p($song->getArtist()->getNameString($_['l10n']));?></artist>
		<albumartist id='<?php p($song->getAlbum()->getAlbumArtist()->getId());?>'><?php p($song->getAlbum()->getAlbumArtist()->getNameString($_['l10n']));?></albumartist>
		<album id='<?php p($song->getAlbum()->getId());?>'><?php p($song->getAlbum()->getNameString($_['l10n']));?></album>
