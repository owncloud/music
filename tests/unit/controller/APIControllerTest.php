...
class APIControllerTest extends ControllerTestUtility {
	...
	public function testArtistsFulltree(){
		...
		$this->api->expects($this->exactly(12))
			->method('linkToRoute')
			->will($this->returnCallback($this->getLinkToRouteFunction()));
	...
	public function testAlbumsFulltree(){
		...
		$this->api->expects($this->exactly(14)) // artists uris will be fetched twice
			->method('linkToRoute')
			->will($this->returnCallback($this->getLinkToRouteFunction()));
	...
	public function testAlbum(){
		...
		$this->api->expects($this->exactly(6)) // artists uris will be fetched twice
			->method('linkToRoute')
			->will($this->returnCallback($this->getLinkToRouteFunction()));
